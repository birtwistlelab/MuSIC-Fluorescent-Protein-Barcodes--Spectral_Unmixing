...
df = pd.DataFrame(result_array, columns=[f'Reference {i + 1}' for i in range(17)],
                  index=[f'Reference {i + 1}' for i in range(17)])
...
th.to_excel(file_path + '10_3condition3_remove_mTFP1_fpr_result_17x17.xlsx', index=False)
np.save(result_path + '10_3.condition3_remove_mTFP1_FPR.npy', fpr_list)
np.save(result_path + '10_3.condition3_remove_mTFP1_TPR.npy', tpr_list)
