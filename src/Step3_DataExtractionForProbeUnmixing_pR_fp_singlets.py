# ================================ XL Clemson =================================
# To extract the data from FP singlets
# ================================ XL Clemson =================================
import numpy as np
import pandas as pd
import os
...
# Define the new column order for rearranging the data
...
pR_fp_singlets = {}
# Iterate through all CSV files in the list
for file in files:
    data = pd.read_csv(file)
    col_names = data.columns.tolist()

    updated_col = []
    # Loop through the new_order list and find the index of each column
...
np.save(os.path.join(result_path, '3_pR_fp_singlets.npy'), pR_fp_singlets, allow_pickle=True)
